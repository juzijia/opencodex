...
export const EXPECTED_PRICE_OVERLAYS: readonly ExpectedPriceOverlay[] = [
  ...
  { provider: "qoder", modelId: "Qwen3.8-Flash", cost4: QWEN38_FLASH, source: `vendor list price applied to the Qoder surface; ${QWEN38_FLASH_PRICING}`, verifiedAt: "2026-09-17", status: "verified-derived" },
